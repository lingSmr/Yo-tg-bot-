...
func (s *BotServ) updatingToWithCancel(chatId int64, state int, msgToUsr string) error {
	...
	if err != nil {
		botMsg := tgAPI.NewMessage(chatId, SendErrorConst)
		s.Bot.Send(botMsg)
...
func (s *BotServ) startSwitch(chatId int64) error {
	...
	s.Bot.Send(botMsg)
	err := s.DataBase.UpdateState(chatId, AskNameState, s.Ctx)
	if err != nil {
...
func (s *BotServ) askNameSwtich(chatId int64, msg string) error {
	...
	botMsg.ReplyMarkup = CancelKeyboard
	s.Bot.Send(botMsg)
	s.DataBase.UpdateState(chatId, AddFriendState, s.Ctx)
	return nil
}
...
func (s *BotServ) sendDocument(chatId int64, url string) error {
	...
	if err != nil {
		...
		botMsg.ReplyMarkup = MainMenuConst
		s.Bot.Send(botMsg)
		s.returningToMainMenu(s.Bot, s.DataBase, chatId, s.Ctx)
		return err
	}
...
func (s *BotServ) returningToMainMenu(bot *tgAPI.BotAPI, dataBase DataBase, chatId int64, ctx context.Context) error {
